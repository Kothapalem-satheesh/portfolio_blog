...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "apps.portfolio.context_processors.site_profile",
            ],
        },
    },
]
...
# Give SQLite up to 20 s to wait when another process holds a write lock
# (prevents "database is locked" during concurrent admin/shell usage)
